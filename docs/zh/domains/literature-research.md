...
本案例聚焦成人与儿童肝实质细胞的基因表达研究，重点关注免疫相关通路。它检索 PubMed 中
2023–2025 年发表的论文，以及 bioRxiv 当前滚动检索范围内的近期预印本，随后生成前 14 条富集通路的
...
权限卡片提供 **仅允许一次**、**允许同类操作**和 **拒绝**。选择“允许同类操作”后，当前 Session
中相同操作和资源类别的后续请求无需再次确认。
